...
public class Edimax2101WV2 extends AbstractOpenemsComponent implements DigitalOutput, SymmetricMeter, OpenemsComponent, EventHandler {
	...
	public String debugLog() {
		...
		b.append(stateText);	
		b.append(" " + this.getActivePowerChannel().value().toString());
		return b.toString();
	}
	...
	private void eventBeforeProcessImage() {
		...
		this.getCurrentChannel().setNextValue(relay1current);
		this.getActivePowerChannel().setNextValue(relay1power);
	}
